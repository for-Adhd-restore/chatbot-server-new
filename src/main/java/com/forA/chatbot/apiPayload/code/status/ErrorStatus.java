...
public enum ErrorStatus implements BaseErrorCode {
  ...
  MEDICATION_INVALID_TIME_FORMAT(HttpStatus.BAD_REQUEST, "MEDICATION4002", "시간 형식이 올바르지 않습니다. HH:mm 형식으로 입력해주세요."),
  MEDICATION_NOTIFICATION_TIME_REQUIRED(HttpStatus.BAD_REQUEST, "MEDICATION4003", "알림이 활성화된 경우 알림 시간은 필수입니다."),
  MEDICATION_INVALID_TIME_RANGE(HttpStatus.BAD_REQUEST, "MEDICATION4004", "시간은 00:00 ~ 23:59 범위 내에서 입력해주세요."),
